...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header render={<div className="flex items-center hover:bg-blackAlpha-50 transition-colors w-full min-w-0" />}><AccordionPrimitive.Trigger
              ...
              >
                ...
                />
              </AccordionPrimitive.Trigger>{actions && (
                <div

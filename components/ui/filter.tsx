      ...
      return (
        ...
        >
          <div className="relative inline-flex w-fit">
            ...
            >
              <PopoverTrigger render={<Button ref={ref} type="button" variant="ghost" aria-label={ariaLabels?.popoverTrigger ?? placeholder} aria-describedby={describedBy} aria-expanded={open} disabled={disabled} className={cn(
      ...
      >
        ...
        >
          <Popover open={open} onOpenChange={handleOpenChangeWithSearch}>
            <PopoverTrigger render={<Button ref={setButtonRef} type="button" variant="ghost" disabled={disabled} aria-label={ariaLabels?.popoverTrigger ?? placeholder} aria-describedby={describedBy} aria-expanded={open} style={
